...
<body>
  <div class="sidebar close">
    ...
    <ul class="nav-links">
    <li class = "<?php echo ($currentPage == 'beranda_asistenlab') ? 'active' : ''; ?>">
        <a href="beranda_asistenlab.php">
          <i class='bx bx-grid-alt' ></i>
          <span class="link_name ">Beranda</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="beranda_asistenlab.php">Beranda</a></li>
        </ul>
      </li>
