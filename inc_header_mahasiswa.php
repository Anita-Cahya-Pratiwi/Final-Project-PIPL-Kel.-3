...
<body>
  <div class="sidebar close">
    ...
    <ul class="nav-links">
    <li class="<?php echo ($currentPage == 'beranda_mahasiswa') ? 'active' : ''; ?>">
        <a href="beranda_mahasiswa.php">
          <i class='bx bx-grid-alt' ></i>
          <span class="link_name ">Beranda</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="beranda_mahasiswa.php">Beranda</a></li>
        </ul>
      </li>
      ...
      <li class="<?php echo ($currentPage == 'dpeminjaman_biasa') ? 'active' : ''; ?>">
        <a href="dpeminjaman_biasa.php">
          <i class='bx bx bx-import'></i>
          <span class="link_name">Peminjaman</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name " href="dpeminjaman_biasa.php">Peminjaman</a></li>
        </ul>
      </li>
      <li class="<?php echo ($currentPage == 'dpengembalian_biasa') ? 'active' : ''; ?>">
        <a href="dpengembalian_biasa.php">
          <i class='bx bx bx-export'></i>
          <span class="link_name">Pengembalian</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name " href="dpengembalian_biasa.php">Pengembalian</a></li>
        </ul>
      </li>
      <div class="profile-details">
          ...
          if ($result_adm && mysqli_num_rows($result_adm) > 0) {
              $username = mysqli_fetch_assoc($result_adm);
              $profile_name = $username['nama'];  
          } else {
              $profile_name = "Mahasiswa";  
          }
          ?>
          <div class="name-job">
              <a href="profil_admin.php">
