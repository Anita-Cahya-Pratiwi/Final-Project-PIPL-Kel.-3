...
<body>
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      <li class="<?php echo ($currentPage == 'beranda_kalab') ? 'active' : ''; ?>">
        <a href="beranda_kalab.php">
          <i class='bx bx-grid-alt' ></i>
          <span class="link_name">Beranda</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="beranda_kalab.php">Beranda</a></li>
        </ul>
      </li>
      ...
      <li class = "<?php echo ($currentPage == 'kelola_perbaikan') ? 'active' : ''; ?>">
        <a href="kelola_perbaikan.php">
          <i class='bx bx-wrench'></i>
          <span class="link_name ">Kelola Perbaikan</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="kelola_perbaikan.php">Kelola Perbaikan</a></li>
        </ul>
      </li>
      ...
      <div class="profile-details">
          ...
          if (isset($_SESSION['username'])) {
            ...
            if ($result_adm && mysqli_num_rows($result_adm) > 0) {
                ...
                $profile_name = "Kepala Laboratorium";
            }
          } else {
              $profile_name = "Guest";
          }
          ...
          <div class="name-job">
              <a href="profil_admin.php">
                  ...
                  <div class="job">Kepala Laboratorium</div>
              </a>
          </div>          
